...
- an entry in `.Codex-plugin/plugin.json`

Skills in `personal/`, `in-progress/`, and `deprecated/` must not appear in the top-level `README.md` or `.Codex-plugin/plugin.json`.
